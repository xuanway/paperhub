...
**论文链接**：[https://doi.org/10.1145/3622781.3674190](https://doi.org/10.1145/3622781.3674190)
**作者**：Charly Castes (EPFL,Google), Andrew Baumann (Google)
**会议**：ASPLOS 2025
...
> 该工作面向 Security 场景，围绕 blocking transient-execution attacks with core-gapped confidential VMs 提出系统化优化方案，重点涉及 Sharing、leaking、blocking 等关键技术点。

## 方法简述

- 以 Sharing is leaking 为核心切入点，构建针对 Security 工作负载的优化路径。
