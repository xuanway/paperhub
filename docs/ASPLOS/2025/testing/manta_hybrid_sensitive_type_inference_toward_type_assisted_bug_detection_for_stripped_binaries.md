...
> 该工作面向 Testing 场景，围绕 Hybrid-Sensitive Type Inference Toward Type-Assisted Bug Detection for Stripped Binaries 提出系统化优化方案，重点涉及 Manta、Hybrid-Sensitive、Type 等关键技术点。

## 方法简述

- 以 Manta 为核心切入点，构建针对 Testing 工作负载的优化路径。
