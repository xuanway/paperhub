...
> 该工作面向 ML Compilers 场景，围绕 Optimizing Deep Learning Inference Efficiency through Block Dependency Analysis 提出系统化优化方案，重点涉及 Optimizing、Deep、Learning 等关键技术点。

## 方法简述

- 以 Optimizing 为核心切入点，构建针对 ML Compilers 工作负载的优化路径。
