...
> 该工作面向 Microarchitecture 场景，围绕 Injecting State into Hardware Prefetchers 提出系统化优化方案，重点涉及 ShadowLoad、Injecting、State 等关键技术点。

## 方法简述

- 以 ShadowLoad 为核心切入点，构建针对 Microarchitecture 工作负载的优化路径。
