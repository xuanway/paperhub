...
**论文链接**：[https://doi.org/10.1145/3676641.3716245](https://doi.org/10.1145/3676641.3716245)
**作者**：Jinwoo Jeong (Korea University), Jeongseob Ahn (Korea University)
**会议**：ASPLOS 2025
...
> 该工作面向 Serving LLMs 场景，围绕 Accelerating LLM Serving for Multi-turn Dialogues with Efficient Resource Management 提出系统化优化方案，重点涉及 Accelerating、LLM、Serving 等关键技术点。

## 方法简述

- 以 Accelerating 为核心切入点，构建针对 Serving LLMs 工作负载的优化路径。
