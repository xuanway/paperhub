...
> 该工作面向 Serving LLMs 场景，围绕 Towards Practical W4A4KV4 LLMs Serving 提出系统化优化方案，重点涉及 COMET、Practical、W4A4KV4 等关键技术点。

## 方法简述

- 以 COMET 为核心切入点，构建针对 Serving LLMs 工作负载的优化路径。
