...
**论文链接**：[https://doi.org/10.1145/3676641.3716019](https://doi.org/10.1145/3676641.3716019)
**作者**：Sishuai Gong (Purdue University), Wang Rui (Purdue University), Deniz Altinbüken (Google DeepMind), Pedro Fonseca (Purdue University), Petros Maniatis (Google DeepMind)
**会议**：ASPLOS 2025
...
> 该工作面向 Fuzz Testing 场景，围绕 Effective Kernel Fuzzing with a Learned White-box Test Mutator 提出系统化优化方案，重点涉及 Snowplow、Effective、Kernel 等关键技术点。

## 方法简述

- 以 Snowplow 为核心切入点，构建针对 Fuzz Testing 工作负载的优化路径。
