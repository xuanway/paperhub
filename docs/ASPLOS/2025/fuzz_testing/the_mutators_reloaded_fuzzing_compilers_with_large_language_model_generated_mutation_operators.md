...
**论文链接**：[https://doi.org/10.1145/3622781.3674171](https://doi.org/10.1145/3622781.3674171)
**作者**：Xianfei Ou (Nanjing University), Cong Li (Ant Group,Zhejiang University), Yanyan Jiang (Nanjing University), Chang Xu (Nanjing University)
**会议**：ASPLOS 2025
...
> 该工作面向 Fuzz Testing 场景，围绕 Fuzzing Compilers with Large Language Model Generated Mutation Operators 提出系统化优化方案，重点涉及 Mutators、Reloaded、Fuzzing 等关键技术点。

## 方法简述

- 以 The Mutators Reloaded 为核心切入点，构建针对 Fuzz Testing 工作负载的优化路径。
