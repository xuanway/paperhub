...
**论文链接**：[https://doi.org/10.1145/3669940.3707278](https://doi.org/10.1145/3669940.3707278)
**作者**：Moinuddin Qureshi (Georgia Institute of Technology), Salman Qazi (Google)
**会议**：ASPLOS 2025
...
> 该工作面向 Memory & Storage 场景，围绕 Securely Mitigating Rowhammer with Per-Row Activation Counters 提出系统化优化方案，重点涉及 MOAT、Securely、Mitigating 等关键技术点。

## 方法简述

- 以 MOAT 为核心切入点，构建针对 Memory & Storage 工作负载的优化路径。
