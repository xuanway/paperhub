...
> 该工作面向 Trust 场景，围绕 Unifying Heterogeneous TEE Granularity for Efficient Secure Collaborative Tensor Computing 提出系统化优化方案，重点涉及 TensorTEE、Unifying、Heterogeneous 等关键技术点。

## 方法简述

- 以 TensorTEE 为核心切入点，构建针对 Trust 工作负载的优化路径。
