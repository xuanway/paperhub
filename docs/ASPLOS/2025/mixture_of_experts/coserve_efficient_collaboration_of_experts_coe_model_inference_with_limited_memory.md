...
> 该工作面向 Mixture of Experts 场景，围绕 Efficient Collaboration-of-Experts (CoE) Model Inference with Limited Memory 提出系统化优化方案，重点涉及 CoServe、Collaboration-of-Experts、CoE 等关键技术点。

## 方法简述

- 以 CoServe 为核心切入点，构建针对 Mixture of Experts 工作负载的优化路径。
