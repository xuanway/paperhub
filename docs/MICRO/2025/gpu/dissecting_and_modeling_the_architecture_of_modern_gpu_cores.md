...
**论文链接**：
**作者**：Rodrigo Huerta, Mojtaba Abaie Shoushtary, José-Lorenzo Cruz, Antonio Gonzalez (Universitat Politecnica de Catalunya)
**会议**：MICRO 2025
...
> 该工作面向 GPU 场景，围绕 Dissecting and Modeling the Architecture of Modern GPU Cores 提出系统化优化方案，重点涉及 Dissecting、Modeling、Modern 等关键技术点。

## 方法简述

- 以 Dissecting 为核心切入点，构建针对 GPU 工作负载的优化路径。
