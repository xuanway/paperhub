...
**论文链接**：
**作者**：Jungi Lee, Junyong Park, Soohyun Cha, Jaehoon Cho, Jaewoong Sim (Seoul National Univ.)
**会议**：MICRO 2025
...
> 该工作面向 Systems for AI (Quantization) 场景，围绕 Pushing the Limits of Microscaling Formats for Efficient Large Language Model Serving 提出系统化优化方案，重点涉及 MX+、Pushing、Limits 等关键技术点。

## 方法简述

- 以 MX+ 为核心切入点，构建针对 Systems for AI (Quantization) 工作负载的优化路径。
