...
> 该工作面向 Memory 场景，围绕 Locality-Aware Atomic Memory Operations on Chiplets 提出系统化优化方案，重点涉及 Delegato、Locality-Aware、Atomic 等关键技术点。

## 方法简述

- 以 Delegato 为核心切入点，构建针对 Memory 工作负载的优化路径。
